...
function makeAutoVisualPrompt(userText,answerText){return `Create a high-quality 16:9 Grade 7 educational science visual when the request is scientific. Prefer a realistic scientific illustration, anatomical cutaway, labelled structure, laboratory-style setup, or clearly staged process rather than generic boxes. Use accurate spatial relationships, short readable callouts, leader lines, arrows, subtle depth/lighting, clean hierarchy and presentation-ready 2K detail. Keep labels to concise keywords, never paragraphs, and do not invent structures or unsupported facts. Topic/request: ${userText}. Key answer context: ${String(answerText||'').slice(0,1800)}. If it is code or game-development help instead, visualize the logic, system architecture, mechanics, or steps rather than reproducing long code.`;}
